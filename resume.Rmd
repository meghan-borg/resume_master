...
research <- tribble(
    ...
    list("Led all aspects of 8+ mixed-methods research studies on youth mental health", "Collected data from 3500+ partipants using surveys, interviews, and physiological measures (e.g., EEG)", "Managed four research projects end-to-end", "Communicated insights in 10 presentations at scientific conferences"),
    "Co-Instructor", "Data Science for Academic and Applied Research - Department of Psychology", "January", 2022, "April", 2023, "Brock University", list("Prepare course materials and deliver lectures to 300+ senior-level students", "Teach students project database management, data cleaning, analyses, and visualization using R and Excel, and how to communicate research findings to non-technical audiences using oral and written deliverables", "Received an overall evaluation rating of 4.9/5"),
    
    "Research Assistant", "Adolescent Development Lab - Department of Psychology", "May", 2022, "April", 2023, "Brock University", 
    list("Assisted in preparing and writing a large SSHRC Partnership Grant which involved 20 organizations including WHO/PAHO and UNICEF", "Facilitated a large hybrid two-day planning meeting with partners")
)
...
* Ranked first out of 160 doctoral students to receive a competitive nationwide scholarship ($105,000)
